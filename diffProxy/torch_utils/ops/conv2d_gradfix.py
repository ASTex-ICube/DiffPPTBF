...
def _conv2d_gradfix(transpose, weight_shape, stride, padding, output_padding, dilation, groups):
    ...
    class Conv2dGradWeight(torch.autograd.Function):
        ...
        def forward(ctx, grad_output, input, bias):
            ...
            return torch.ops.aten.convolution_backward(grad_output, input, empty_weight, bias_sizes=bias_shape, stride=stride, padding=padding, dilation=dilation, transposed=transpose, output_padding=output_padding, groups=groups, output_mask=[0,1,0])[1]
