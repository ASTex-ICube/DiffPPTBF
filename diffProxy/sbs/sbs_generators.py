...
class PPTBF(SBSGenerators):
    @staticmethod
    def get_params():
        params = OrderedDict([('tiling', RandomSampler((0,), (13,), (0,), True)),
                              ('zoom', RandomSampler((1.0,), (20.0,), (5.0,), False)),
                              ('alpha', RandomSampler((0.0,), (2.0,), (0.0,), False)),
                              ('jitter', RandomSampler((0.01,), (0.5,), (0.01,), False)),
                              ('normblend', RandomSampler((0.0,), (1.0,), (1.0,), False)),
                              ('wsmooth', RandomSampler((0.0,), (1.0,), (0.0,), False)),
                              ('winfeatcorrel', RandomSampler((0.0,), (1.0,), (0.0,), False)),
                              ('larp', RandomSampler((0.0,), (1.0,), (0.0,), False)),
                              ('feataniso', RandomSampler((0.0,), (5.0,), (0.0,), False)),
                              ('sigcos', RandomSampler((0.0,), (10.0,), (0.0,), False)),
                              ('deltaorient', RandomSampler((-0.1*np.pi,), (0.1*np.pi,), (0.0,), False)),
                              ('amp', RandomSampler((0.0,), (0.15,), (0.0,), False)),
                              ('rx', RandomSampler((0,), (10,), (0,), True)),
                              ('ry', RandomSampler((0,), (10,), (0,), True)),
                              ('tx', RandomSampler((-20.0,), (20.0,), (0.0,), False)),
                              ('ty', RandomSampler((-20.0,), (20.0,), (0.0,), False)),
                              ])
        return params


class PPTBF2(SBSGenerators):
    @staticmethod
    def get_params():
        params = OrderedDict([('threshold', RandomSampler((0.0,), (1.0,), (0,), False)),
                              ('tiling', RandomSampler((0,), (16,), (0,), True)),
                              ('jittering', RandomSampler((0.01,), (0.91,), (0,), False)),
                              ('resolution', RandomSampler((20,), (150,), (0,), True)),
                              ('rotation', RandomSampler((0.0,), (0.125,), (0,), False)),
                              ('aspect_ratio', RandomSampler((1.0,), (3.0,), (0,), False)),
                              ('distortion_base', RandomSampler((0.0,), (0.18,), (0,), False)),
                              ('distortion_amplitude', RandomSampler((0.0,), (0.5,), (0,), False)),
                              ('distortion_frequency', RandomSampler((1.0,), (2.0,), (0,), False)),
                              ('window_arity', RandomSampler((3.0,), (10.0,), (0,), False)),
                              ('window_larp', RandomSampler((0.0,), (0.9,), (0,), False)),
                              ('window_norm', RandomSampler((1.0,), (3.0,), (0,), False)),
                              ('window_smoothness', RandomSampler((0.0,), (2.0,), (0,), False)),
                              ('window_blend', RandomSampler((0.6,), (1,), (0,), False)),
                              ('window_sigma', RandomSampler((0.5,), (0.7,), (0,), False)),
                              ('feature_norm', RandomSampler((2.0,), (2.0,), (0,), False)),
                              ('feature_correlation', RandomSampler((0,), (0.7,), (0,), False)),
                              ('feature_aniso', RandomSampler((0.0,), (5.0,), (0,), False)),
                              ('feature_kernel_min', RandomSampler((1,), (9,), (0,), True)),
                              ('feature_kernel_max', RandomSampler((1,), (9,), (0,), True)),
                              ('feature_sigcos', RandomSampler((1.0,), (2.0,), (0,), False)),
                              ('feature_sigcosvar', RandomSampler((0.2,), (0.2, ), (0,), False)),#21
                              ('feature_frequency', RandomSampler((0,), (8,), (0,), True)),
                              ('feature_phase_shift', RandomSampler((0.0,), (0.0,), (0,), False)),
                              ('feature_thickness', RandomSampler((0.1,), (1,), (0,), False)),
                              ('feature_curvature', RandomSampler((0.0,), (1.0,), (0,), False)),
                              ('feature_orientation', RandomSampler((0.0,), (0.45,), (0,), False)),
                              ])
        return params
